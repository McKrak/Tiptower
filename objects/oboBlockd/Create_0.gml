...
physics_fixture_add_point(fix, 32-cx, 16-cy); // that are based on distance from
physics_fixture_add_point(fix, 32-cx, 48-cy);  // the sprite origin
...
physics_fixture_add_point(fix2, 16-cx,0-cy);      // using these points
physics_fixture_add_point(fix2, 32-cx, 0-cy); // that are based on distance from
physics_fixture_add_point(fix2, 32-cx, 16-cy);  // the sprite origin
